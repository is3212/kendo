...
<c:url var="vendorUrl" value="/vendor/list" />
	...
	<kendo:grid title="회사리스트" name="vendorGrid" height="320px"
		...
		<kendo:dataSource pageSize="20" batch="true">
			<kendo:dataSource-transport>
				<kendo:dataSource-transport-read url="${vendorUrl}" dataType="json"
					type="POST" contentType="application/json" />
					<kendo:dataSource-transport-create url="${v_createUrl}" dataType="json" type="POST" 
				contentType="application/json"/>
				<kendo:dataSource-transport-destroy url="${v_deleteUrl}" dataType="json" type="POST" 
				contentType="application/json"/>
								<kendo:dataSource-transport-update url="${v_updateUrl}" dataType="json" type="POST" 
				contentType="application/json"/>
